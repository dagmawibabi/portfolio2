<script lang="ts">
	...
	import EachCreativeOutlet from '../each_creative_outlet.svelte';
	import { Mic, NotebookPen, Users } from 'lucide-svelte';
	import podcast from '$lib/assets/creativity/podcast2.jpg';
	import dagmawibabi from '$lib/assets/creativity/community.jpg';
	import blog from '$lib/assets/creativity/blog.jpg';
...
<div class="pb-10">
	...
	<div
		class="flex flex-col justify-evenly gap-y-2 rounded border border-zinc-300 p-2 shadow-md hover:rounded-xl hover:border-black hover:shadow-lg md:flex-col md:gap-y-2 lg:flex-row lg:gap-x-2 xl:flex-row xl:gap-x-2 2xl:flex-row 2xl:gap-x-2 dark:border-zinc-600"
	>
