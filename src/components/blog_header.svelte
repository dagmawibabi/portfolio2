			...
			{#if showDescription}
				<div class="flex flex-col md:gap-y-2">
					...
					<!-- <p class="text-sm">
							...
							projects. My main focus these days is building modern, minimal and powerful products
							and digital experiences at Dream Intelligence for the world to explore.
						</p> -->
				</div>
			{/if}
		</div>
